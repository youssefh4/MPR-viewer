...
class DICOM_MPR_Viewer(QWidget):
    ...
    def _create_segmentation_group(self):
        ...
        self.organ_dropdown.addItems(["None", "Lungs", "Heart", "Brain", "Kidneys", "Liver", "Spleen", "Spine", "Ribcage", "Thyroid", "Trachea", "Adrenal", "Gallbladder", "Pancreas", "Prostate", "Esophagus", "Stomach", "Duodenum", "Small Bowel", "Colon", "Urinary Bladder", "Cardiovascular"])
